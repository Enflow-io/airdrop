...
const CONTRACT_KEY: &str = "counter_two";
const COUNT_KEY: &str = "count";
const TEST_NAME: &str = "test-name";

// Constants for the keys pointing to values stored in the account's named keys.
const CONTRACT_PACKAGE_NAME: &str = "counter_two_package_name";
const CONTRACT_ACCESS_UREF: &str = "counter_two_access_uref";
...
fn install_counter() {
    ...
    // counter_named_keys.insert(String::from("purse"), purse.into());
    ...
    // let key_name2 = String::from(COUNT_KEY);
    // counter_named_keys.insert(key_name2, count_start.into());

    // let test_name = String::from(TEST_NAME);
    // counter_named_keys.insert(String::from("balances"),test_name.into());
